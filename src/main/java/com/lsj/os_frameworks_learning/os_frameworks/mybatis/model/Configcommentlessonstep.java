...
public class Configcommentlessonstep {
    private Integer id;
    ...
    public boolean equals(Object that) {
        ...
        Configcommentlessonstep other = (Configcommentlessonstep) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getErrorComment() == null ? other.getErrorComment() == null : this.getErrorComment().equals(other.getErrorComment()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getErrorComment() == null) ? 0 : getErrorComment().hashCode());
