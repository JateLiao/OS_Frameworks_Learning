package com.lsj.os_frameworks_learning.os_frameworks.influxdb;
...
public class InfluxDBJavaTest {
    ...
    private String database = "grafana_data";//数据库
...
//		influxDB.createDB(database);
    ...
    public void testInsert() {//测试数据插入
        ...
        info1.setCreatedAt(System.currentTimeMillis());
        ...
        info2.setCreatedAt(System.currentTimeMillis());
    ...
    public void testQuery() {//测试数据查询
        ...
        System.out.println("查询结果：" + JsonUtils.toJson(lists));
